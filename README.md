...
the goal of this project is to sort a number list but with some restrictions.
you have two list a and b at the beggining the b_list is empty and all the numbers are in the a_list.
the operations are :
